...
function Project({ project }) {
    ...
    const { title, image_url, summary, topics, links } = project;
...
function Tag({ topic, color }) {

    return (<>
        <span style={{ backgroundColor: color }} className="tag">{topic}</span>
    </>)
}
